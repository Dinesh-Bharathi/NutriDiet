...
export function mapTemplate(tpl) {
  ...
  return {
    ...
    recommendations: tpl.recommendations || null,
    lifestyleAdvice: tpl.lifestyleAdvice || null,
    hydration: tpl.hydration || null,
    supplementNotes: tpl.supplementNotes || null,
    mealPrepNotes: tpl.mealPrepNotes || null,
